    ...
    class ConceptKey {
        ...
        public override bool Equals(object obj) {
            if (obj is ConceptKey) {
                ...
                return exCode.Equals(parsedV.exCode) && costingCode.Equals(parsedV.costingCode)
                    //&& costingCode2.Equals(parsedV.costingCode2)
                    // && costingCode3.Equals(parsedV.costingCode3) && costingCode4.Equals(parsedV.costingCode4)
                    // && costingCode5.Equals(parsedV.costingCode5)
                     && etapa.Equals(parsedV.etapa)
